...
const Kids = () => {
     ...
     useEffect(() => {
          const fetchMovie = async () => {
               const resData = await axios.get(`https://api.themoviedb.org/3/movie/${id}?api_key=13d142da634f37232d727abedb6908d7&append_to_response=credits,similar,media_type`)
